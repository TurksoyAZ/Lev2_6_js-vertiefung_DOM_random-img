let data = [

    {
        ...
        download_url: "https://piccsum.photos/id/0/5616/3744"
    },
...
//für Zufälliges Bild Mit Javascript anzeigen
let überSchrift = document.createElement('h1')
überSchrift.textContent = 'Zufälliges Bild Mit Javascript anzeigen'
document.body.appendChild(überSchrift)
...
let randomKreis = () => {
    ...
    let resultRandom = data[random]

    div.textContent = ''
    let bild = document.createElement('img')
    bild.src = resultRandom.download_url
    bild.style.height = '20rem'
